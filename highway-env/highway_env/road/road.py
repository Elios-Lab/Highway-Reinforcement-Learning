...
class RoadNetwork(object):
    ...
    @staticmethod
    def straight_road_network(lanes: int = 2, length: float = 10000, angle: float = 0) -> 'RoadNetwork': #lanes:int = 4
        net = RoadNetwork()
...
class Road(object):
    ...
    #metodo utilizzato sia per vedere se si sono superate macchine sulla dx e sia per la distanza di sicurezza
