...
class ControlledVehicle(Vehicle):
    ...
    def __init__(self,
                 ...
                 route: Route = None):
        super().__init__(vehicle_id, road, position, heading, speed)
    ...
    def create_from(cls, vehicle: "ControlledVehicle") -> "ControlledVehicle":
        ...
        """
        v = cls(vehicle.vehicle_id, vehicle.road, vehicle.position, heading=vehicle.heading, speed=vehicle.speed,
